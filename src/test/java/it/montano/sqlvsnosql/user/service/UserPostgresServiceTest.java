...
class UserPostgresServiceTest {
    ...
    @Mock
    UserPostgresRepository repo;

    @Test
    void createUser(@Given UserRequest request, @Given UserEntity entity, @Given UserResponse response) {
    ...
    @Test
    void deleteUser(@Given UUID userId) {
    ...
    @Test
    void getUserById(@Given UUID userId, @Given UserEntity entity, @Given UserResponse response) {
    ...
    @Test
    void getUsers(@Given List<UserEntity> entities, @Given UserResponse response) {
